...
\arguments{
  ...
  \item{verbose}{Ahether to print messages.}

}
\details{
The function runs consensus partitioning by \code{\link{consensus_partition}} for all combinations of top-value methods and partition methods.
