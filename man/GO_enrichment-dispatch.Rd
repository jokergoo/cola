\name{GO_enrichment-dispatch}
\alias{GO_enrichment}
\title{
Method dispatch page for GO_enrichment
}
\description{
Method dispatch page for \code{GO_enrichment}.
}
\section{Dispatch}{
\code{GO_enrichment} can be dispatched on following classes:

\itemize{
\item \code{\link{GO_enrichment,HierarchicalPartition-method}}, \code{\link{HierarchicalPartition-class}} class method
