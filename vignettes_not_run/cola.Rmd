...
```{r, results = "hide"}
res_list = run_all_consensus_partition_methods(mat, top_n = c(1000, 2000), max_k = 6,
	top_value_method = c("MAD", "cv"), partition_method = c("hclust", "kmeans"), 
	anno = anno, anno_col = anno_col)
res_list
```
