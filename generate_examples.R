...
source("~/project/development/cola/inst/extdata/test_Golub.R")
source("~/project/development/cola/inst/extdata/test_tcga_gbm.R")
source("~/project/development/cola/inst/extdata/test_Ritz_ALL.R")
source("~/project/development/cola/inst/extdata/test_HSMM_single_cell.R")
