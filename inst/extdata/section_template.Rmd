...
```{r, echo = FALSE, message = FALSE}
message("  - collecting all plots (k = '<%=paste(all_k, collapse=', ')%>')")
```
...
```{r, echo = FALSE, message = FALSE}
message("  - plotting various statistics for selecting best k")
```
...
```{r, echo = FALSE, message = FALSE}
message("  - making consensus heatmaps (k = '<%=paste(all_k, collapse=', ')%>')")
```
...
```{r, echo = FALSE, message = FALSE}
message("  - making membership heatmaps (k = '<%=paste(all_k, collapse=', ')%>')")
```
...
```{r, echo = FALSE, message = FALSE}
message("  - getting signatures (k = '<%=paste(all_k, collapse=', ')%>')")
```
...
```{r, echo = FALSE, message = FALSE}
message("  - making PCA plots (k = '<%=paste(all_k, collapse=', ')%>')")
```
