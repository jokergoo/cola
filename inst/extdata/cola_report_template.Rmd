...
densityHeatmap(res_list@.env$data, top_annotation = HeatmapAnnotation(df = res_list@list[[1]]@known, col = res_list@list[[1]]@known_col))
```
...
[% k = res_list@list[[1]]@k
qq("knitr_add_tab_item('collect_plots(res_list, k = @<k>, fun = consensus_heatmap)', 'k = @<k>', opt = 'fig.width = 14, fig.height = 14*length(all_top_value_methods())/length(all_partition_methods()')\n", code.pattern = "@<CODE>") %]
knitr_insert_tabs()
```
...
```{r, results = "asis", echo = FALSE, include = TRUE}
[% k = res_list@list[[1]]@k
qq("knitr_add_tab_item('collect_plots(res_list, k = @<k>, fun = membership_heatmap)', 'k = @<k>', opt = 'fig.width = 14, fig.height = 14*length(all_top_value_methods())/length(all_partition_methods()')\n", code.pattern = "@<CODE>") %]
knitr_insert_tabs()
```
...
```{r, results = "asis", echo = FALSE, include = TRUE}
[% k = res_list@list[[1]]@k
qq("knitr_add_tab_item('collect_plots(res_list, k = @<k>, fun = get_signatures)', 'k = @<k>', opt = 'fig.width = 14, fig.height = 14*length(all_top_value_methods())/length(all_partition_methods()')\n", code.pattern = "@<CODE>") %]
knitr_insert_tabs()
```
