...
```{r, fig.width = 12, fig.height = 7, fig.cap = "Figure @{i_figure}. Gene ontology enrichment on the three sets of genes illustrated in the previous Figure."}
...
Functional enrichment was not applied because the matrix rows cannot be mapped to genes.
