...
provides metrics to help to determine the best number of subgroups. For the
topic of determining best number of groups from clustering, please refer to [the
NbClust package](https://CRAN.R-project.org/package=NbClust).
