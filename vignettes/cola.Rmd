...
```{r, echo = FALSE}
knitr::include_graphics("rand_jaccard.png")
```
...
- `samr` and `pamr`: use [SAM](*https://cran.r-project.org/web/packages/samr/index.html)/[PAM](http://www.bioconductor.org/packages/2.8/bioc/html/pamr.html) method to find significantly different rows between
  subgroups.
