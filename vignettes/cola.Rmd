...
plots) for this analysis which can be visited at https://jokergoo.github.io/cola_examples/TCGA_GBM_subgroup_cola_report/cola_report.html.

```{r, eval = FALSE}
cola_report(rl, output_dir = "~/your-output-folder/tcga_cola_rl_report")
```
