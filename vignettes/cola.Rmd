...
In the following example code, `TCGA_GBM_subgroup.rds` is generated by the code
...
To get results for a single top-value method and partitioning method, you can subset `rl`
...
where four subtypes are predicted.
