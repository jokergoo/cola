...
res = run_all_consensus_partition_methods(data, top_n = c(1000, 2000, 4000), k = 2:6, p_sampling = p, 
	known_anno = data.frame(phenotype = anno_old$phenotype[l]),
...
# 	cmd = qq("Rscript-3.3.1 /home/guz/project/development/cola/test_not_run/test_asthma_dkfz.R --p @{p} --ncore 4")
# 	cmd = qq("perl /home/guz/project/development/ngspipeline2/qsub_single_line.pl '-l walltime=40:00:00,mem=20G,nodes=1:ppn=4 -N lina_asthma_dkfz_subgroup_p@{p}' '@{cmd}'")
# 	system(cmd)
# }
