...
image = grImport2::readPicture(temp_file)
file.remove(temp_file)
pushViewport(viewport(x = 0.5, y = 5/6, width = 1/3, height = 1/3))
grid.rect(gp = gpar(fill = bg[1], col = NA))
grImport2::grid.picture(image)
popViewport()
...
image = grImport2::readPicture(temp_file)
file.remove(temp_file)
pushViewport(viewport(x = 1/3, y = 1/2, width = 1/3, height = 1/3))
grid.rect(gp = gpar(fill = bg[2], col = NA))
grImport2::grid.picture(image)
popViewport()
...
image = grImport2::readPicture(temp_file)
file.remove(temp_file)
pushViewport(viewport(x = 2/3, y = 1/2, width = 1/3, height = 1/3))
grid.rect(gp = gpar(fill = bg[3], col = NA))
grImport2::grid.picture(image)
popViewport()
...
image = grImport2::readPicture(temp_file)
file.remove(temp_file)
pushViewport(viewport(x = 1/6, y = 1/6, width = 1/3, height = 1/3))
grid.rect(gp = gpar(fill = bg[4], col = NA))
grImport2::grid.picture(image)
popViewport()
...
image = grImport2::readPicture(temp_file)
file.remove(temp_file)
pushViewport(viewport(x = 1/2, y = 1/6, width = 1/3, height = 1/3))
grid.rect(gp = gpar(fill = bg[1], col = NA))
grImport2::grid.picture(image)
popViewport()
...
image = grImport2::readPicture(temp_file)
file.remove(temp_file)
pushViewport(viewport(x = 5/6, y = 1/6, width = 1/3, height = 1/3))
grid.rect(gp = gpar(fill = bg[2], col = NA))
grImport2::grid.picture(image)
popViewport()
