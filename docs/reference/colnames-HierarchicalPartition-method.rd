...
<title>Column names of the matrix — colnames-HierarchicalPartition-method • cola</title>
...
<meta property="og:title" content="Column names of the matrix — colnames-HierarchicalPartition-method" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>colnames-HierarchicalPartition-method.rd</code></div>
    </div>
