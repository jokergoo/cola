...
<span class='fu'><a href='get_signatures-dispatch.rd.html'>get_signatures</a></span>(<span class='no'>object</span>, <span class='no'>k</span>,
...
<dl class='dl-horizontal'>
  ...
  <dt>other_columns:</dt><dd><p>the mean expression (depending rows are scaled or not) in each subgroup.</p></dd>
