...
<title>Get the original matrix — get_matrix-HierarchicalPartition-method • cola</title>
...
<meta property="og:title" content="Get the original matrix — get_matrix-HierarchicalPartition-method" />
<meta property="og:description" content="Get the original matrix" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Get the original matrix</h1>
    
    <div class="hidden name"><code>get_matrix-HierarchicalPartition-method.rd</code></div>
    </div>

    <div class="ref-description">
    <p>Get the original matrix</p>
    </div>

    <pre class="usage"><span class='co'># S4 method for HierarchicalPartition</span>
<span class='fu'><a href='get_matrix-dispatch.rd.html'>get_matrix</a></span>(<span class='no'>object</span>)</pre>
