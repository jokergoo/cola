...
<title>Dimension of the matrix — dim.HierarchicalPartition • cola</title>
...
<meta property="og:title" content="Dimension of the matrix — dim.HierarchicalPartition" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>dim.HierarchicalPartition.rd</code></div>
    </div>
    ...
    <pre class="usage"><span class='co'># S3 method for HierarchicalPartition</span>
