...
<title>Dimension of the matrix — dim.ConsensusPartition • cola</title>
...
<meta property="og:title" content="Dimension of the matrix — dim.ConsensusPartition" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>dim.ConsensusPartition.rd</code></div>
    </div>
    ...
    <pre class="usage"><span class='co'># S3 method for ConsensusPartition</span>
