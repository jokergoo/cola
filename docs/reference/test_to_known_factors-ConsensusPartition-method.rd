...
<title>Test correspondance between predicted classes and known factors — test_to_known_factors-ConsensusPartition-method • cola</title>
...
<meta property="og:title" content="Test correspondance between predicted classes and known factors — test_to_known_factors-ConsensusPartition-method" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>test_to_known_factors-ConsensusPartition-method.rd</code></div>
    </div>
...
<span class='fu'><a href='test_to_known_factors-dispatch.rd.html'>test_to_known_factors</a></span>(<span class='no'>object</span>, <span class='no'>k</span>, <span class='kw'>known</span> <span class='kw'>=</span> <span class='fu'><a href='get_anno-dispatch.rd.html'>get_anno</a></span>(<span class='no'>object</span>),
    ...
    <tr>
      ...
      <td><p>Cutoff for sihouette scores. Samples with value less than it are omit.</p></td>
    </tr>
    <tr>
      <th>verbose</th>
...
<li><p>number of partitions</p></li>
    ...
    <div class='dont-index'><p><code><a href='test_between_factors.rd.html'>test_between_factors</a></code></p></div>
...
<span class='fu'><a href='test_to_known_factors-dispatch.rd.html'>test_to_known_factors</a></span>(<span class='no'>cola_rl</span>[<span class='fl'>1</span>, <span class='fl'>1</span>], <span class='kw'>known</span> <span class='kw'>=</span> <span class='fl'>1</span>:<span class='fl'>40</span>)</div><div class='output co'>#&gt;            n     known(p) k
#&gt; sd:hclust 60 5.168296e-13 2
#&gt; sd:hclust 59 1.545023e-12 3
#&gt; sd:hclust 59 1.545023e-12 4
#&gt; sd:hclust 40           NA 5
#&gt; sd:hclust 35           NA 6</div></pre>
  </div>
