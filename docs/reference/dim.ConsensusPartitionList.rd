...
<title>Dimension of the matrix — dim.ConsensusPartitionList • cola</title>
...
<meta property="og:title" content="Dimension of the matrix — dim.ConsensusPartitionList" />
<meta property="og:description" content="Dimension of the matrix" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Dimension of the matrix</h1>
    
    <div class="hidden name"><code>dim.ConsensusPartitionList.rd</code></div>
    </div>
    ...
    <pre class="usage"><span class='co'># S3 method for ConsensusPartitionList</span>
