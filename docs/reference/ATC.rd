...
<title>Ability to correlate other rows in the matrix — ATC • cola</title>
...
<meta property="og:title" content="Ability to correlate other rows in the matrix — ATC" />
<meta property="og:description" content="Ability to correlate other rows in the matrix" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Ability to correlate other rows in the matrix</h1>
    
    <div class="hidden name"><code>ATC.rd</code></div>
    </div>

    <div class="ref-description">
    <p>Ability to correlate other rows in the matrix</p>
    </div>

    <pre class="usage"><span class='fu'><a href='ATC.rd.html'>ATC</a></span>(<span class='no'>mat</span>, <span class='kw'>cor_fun</span> <span class='kw'>=</span> <span class='kw pkg'>stat</span><span class='kw ns'>::</span><span class='no'>cor</span>, <span class='kw'>min_cor</span> <span class='kw'>=</span> <span class='fl'>0</span>, <span class='kw'>power</span> <span class='kw'>=</span> <span class='fl'>1</span>,
    <span class='kw'>mc.cores</span> <span class='kw'>=</span> <span class='fl'>1</span>, <span class='kw'>n_sampling</span> <span class='kw'>=</span> <span class='fl'>1000</span>, <span class='kw'>q_sd</span> <span class='kw'>=</span> <span class='fl'>0</span>, <span class='no'>...</span>)</pre>
...
<span class='no'>ATC_score</span> <span class='kw'>=</span> <span class='fu'><a href='ATC.rd.html'>ATC</a></span>(<span class='no'>mat</span>)
