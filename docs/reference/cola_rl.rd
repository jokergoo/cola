...
<title>Example ConsensusPartitionList object — cola_rl • cola</title>
...
<meta property="og:title" content="Example ConsensusPartitionList object — cola_rl" />
<meta property="og:description" content="Example ConsensusPartitionList object" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Example ConsensusPartitionList object</h1>
    
    <div class="hidden name"><code>cola_rl.rd</code></div>
    </div>

    <div class="ref-description">
    <p>Example ConsensusPartitionList object</p>
    </div>

    <pre class="usage"><span class='fu'><a href='https://rdrr.io/r/utils/data.html'>data</a></span>(<span class='no'>cola_rl</span>)</pre>


    <h2 class="hasAnchor" id="details"><a class="anchor" href="#details"></a>Details</h2>

    <p>Following code was used to generate <code>cola_rl</code>:</p>
<p></p><pre>
  set.seed(123)
  ...
  cola_rl = run_all_consensus_partition_methods(data = m, top_n = c(20, 30, 40))  </pre>
