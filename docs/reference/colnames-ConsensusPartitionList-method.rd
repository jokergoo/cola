...
<title>Column names of the matrix — colnames-ConsensusPartitionList-method • cola</title>
...
<meta property="og:title" content="Column names of the matrix — colnames-ConsensusPartitionList-method" />
<meta property="og:description" content="Column names of the matrix" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Column names of the matrix</h1>
    
    <div class="hidden name"><code>colnames-ConsensusPartitionList-method.rd</code></div>
    </div>

    <div class="ref-description">
    <p>Column names of the matrix</p>
    </div>

    <pre class="usage"><span class='co'># S4 method for ConsensusPartitionList</span>
<span class='fu'><a href='colnames-dispatch.rd.html'>colnames</a></span>(<span class='no'>x</span>)</pre>
