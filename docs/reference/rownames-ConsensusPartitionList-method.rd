...
<title>Row names of the matrix — rownames-ConsensusPartitionList-method • cola</title>
...
<meta property="og:title" content="Row names of the matrix — rownames-ConsensusPartitionList-method" />
<meta property="og:description" content="Row names of the matrix" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Row names of the matrix</h1>
    
    <div class="hidden name"><code>rownames-ConsensusPartitionList-method.rd</code></div>
    </div>

    <div class="ref-description">
    <p>Row names of the matrix</p>
    </div>

    <pre class="usage"><span class='co'># S4 method for ConsensusPartitionList</span>
<span class='fu'><a href='rownames-dispatch.rd.html'>rownames</a></span>(<span class='no'>x</span>)</pre>
