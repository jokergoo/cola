...
<title>Get annotation colors — get_anno_col-HierarchicalPartition-method • cola</title>
...
<meta property="og:title" content="Get annotation colors — get_anno_col-HierarchicalPartition-method" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>get_anno_col-HierarchicalPartition-method.rd</code></div>
    </div>
...
<span class='fu'><a href='get_anno_col-dispatch.rd.html'>get_anno_col</a></span>(<span class='no'>object</span>)</pre>
    ...
    <p>A list of color vectors or <code>NULL</code>.</p>
