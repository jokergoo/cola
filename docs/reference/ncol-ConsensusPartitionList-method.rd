...
<title>Number of columns in the matrix — ncol-ConsensusPartitionList-method • cola</title>
...
<meta property="og:title" content="Number of columns in the matrix — ncol-ConsensusPartitionList-method" />
<meta property="og:description" content="Number of columns in the matrix" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Number of columns in the matrix</h1>
    
    <div class="hidden name"><code>ncol-ConsensusPartitionList-method.rd</code></div>
    </div>
...
<span class='fu'><a href='ncol-dispatch.rd.html'>ncol</a></span>(<span class='no'>x</span>)</pre>
